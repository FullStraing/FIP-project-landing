      ...
      <section className="px-4 py-16 bg-brand-light">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-brand-blue/80 mb-8 max-w-3xl">
            Визуальные отчеты показывают, как ребенок проводит время в
            приложении, какие темы его интересуют и как меняется активность
          </p>
          <div className="rounded-3xl bg-white p-6 grid gap-6 md:grid-cols-3">
            ...
            <div>
              <p className="text-sm text-brand-blue/60 mb-1">Активные дни</p>
